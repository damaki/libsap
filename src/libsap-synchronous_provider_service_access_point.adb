...
is
   ...
   procedure Build_And_Send_Request (Promise : in out Confirm_Promise) is
   ...
   begin
      Allocate_Request (Handle);
      Build_Request_Wrapper (Handle);
      Send_Request (Handle, Promise);

      pragma Unreferenced (Handle);
   end Build_And_Send_Request;

   ---------------------------------------
   -- Build_And_Send_Request_No_Confirm --
   ---------------------------------------

   procedure Build_And_Send_Request_No_Confirm is

      procedure Build_Request_Wrapper is new Build_Request_No_Confirm (Build);

      Handle  : Request_Handle;
      Promise : Confirm_Promise;
   begin
      Allocate_Request (Handle);
      Build_Request_Wrapper (Handle);
      Send_Request (Handle, Promise);
   ...
   end Build_And_Send_Request_No_Confirm;

   -----------------------------------------
   -- Build_And_Send_Request_With_Confirm --
   -----------------------------------------
   ...
   is
      ...
      procedure Build_Request_Wrapper is new
        Build_Request_With_Confirm (Build);
   ...
   begin
      ...
      pragma Unreferenced (Handle);
   end Build_And_Send_Request_With_Confirm;
